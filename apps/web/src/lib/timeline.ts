import type { AgentRun, ApprovalRequest, PolicyDecision } from "../types";
...
/**
 * Merges Run outcomes, PolicyDecisions, and ApprovalRequests into one
 * chronological feed. A blocked/held/terminated Run does not get its own
